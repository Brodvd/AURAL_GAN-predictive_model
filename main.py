    ...
    try:
        ...
        if generated_spectrogram is not None:
            try:
                ...
                generated_audio = generator.spectrogram_to_audio(generated_spectrogram, test_phase, './Audio/output.wav')
                print(f"Generated audio: {generated_audio}")
            except Exception as e:
                print(f"couldn't discriminate: {e}")
                traceback.print_exc()
...
if __name__ == "__main__":
    main()
    file_path = input("./Audio/beat Ennio.wav")
